...
export default function HeroSection({
  ...
  const vm = useMemo(() => {
    ...
    return {
      ...
      hours: site?.hours?.[0]?.time || t("home.hoursFallback", "Sun–Thu 9:30 AM – 5:30 PM"),
    };
  }, [hero, site, t]);
  ...
  return (
    <section className="relative overflow-hidden text-white -mt-16 sm:-mt-20 pt-16 sm:pt-20">
      ...
      <Container className="relative">
                      ...
                      {vm.stats.map((s, idx) => (
                        <StaggerItem key={idx} y={10}>
                          <div>
                            ...
                            <div className="mt-1 text-small text-white/70">{s.label}</div>
                          </div>
                        </StaggerItem>
                      ))}
                    </Stagger>
        ...
        {/* Floating card stays in this section because it's tightly coupled to hero */}
                ...
                <div className="grid gap-6 sm:grid-cols-3 sm:items-center sm:gap-0">
                  ...
                  <div className="relative flex items-center gap-4 sm:px-8 sm:py-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 text-[14px] text-muted">{vm.hours}</div>
                    </div>
                  </div>
